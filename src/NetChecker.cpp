...
// ──────────────────────────────────────────────────────────────────────────────
CNetCheckerApp theApp;

BEGIN_MESSAGE_MAP(CNetCheckerApp, CWinApp)
END_MESSAGE_MAP()

CNetCheckerApp::CNetCheckerApp()
{
...
// ──────────────────────────────────────────────────────────────────────────────
BOOL CNetCheckerApp::InitInstance()
{
...
// ──────────────────────────────────────────────────────────────────────────────
int CNetCheckerApp::ExitInstance()
{
